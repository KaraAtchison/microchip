...
const uint16_t mchpTouchScreenVersion = 0xF200 | CALIBRATIONINSET;
...
#endif   
#ifdef ADC_POT
    ADPCFG_POT = RESISTIVETOUCH_ANALOG;
#endif	
...
/*********************************************************************
* Function: int16_t TouchGetADCPot()
*
* PreCondition: none
*
* Input: none
...
*
********************************************************************/
int16_t TouchGetADCPot(void)
{
    return ((int16_t)adcPot);
}
